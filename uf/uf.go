...
// The UnionFind represents a union–find testdata type (also known as the disjoint-sets testdata type).
// It supports the classic union and find operations, along with a count operation that returns
// the total number of sets.
//
// The union–find testdata type models a collection of sets containing n elements, with each element
